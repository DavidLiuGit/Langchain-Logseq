...
class TestLogseqJournalDateRangeRetriever(unittest.TestCase):
    def setUp(self):
        ...
        self.retriever = LogseqJournalDateRangeRetriever(self.mock_contextualizer, self.mock_loader)
    ...
    def test_get_relevant_documents_with_chat_history(self):
        ...
        # Execute
        result = self.retriever._get_relevant_documents(query, run_manager=mock_run_manager, chat_history=chat_history)
